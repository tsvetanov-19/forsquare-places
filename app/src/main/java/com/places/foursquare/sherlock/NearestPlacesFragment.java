 ...
 */
public class NearestPlacesFragment extends FoursquareFragment implements AccessTokenRequestListener {
    ...
    protected void setUpMap() {
        ...
        if (gps.canGetLocation()) {
            ...
            mMap.moveCamera(CameraUpdateFactory.newLatLngZoom(realPosition, 15));
