    ...
    public void onNavigationDrawerItemSelected(int position) {
        ...
        switch (position){
            case 0 : getSupportFragmentManager().beginTransaction()
                    .replace(R.id.container,new UserPlaceFragment())
                    .commit(); break;
            case 1 : getSupportFragmentManager().beginTransaction()
                    .replace(R.id.container,new NearestPlacesFragment())
                    .commit(); break;
            case 2 : getSupportFragmentManager().beginTransaction()
                    .replace(R.id.container,new CategoryPlacesFragment() {
                    })
                    .commit(); break;
            default :  transitFragment(PlaceholderFragment.newInstance(position) );
        }
    }
